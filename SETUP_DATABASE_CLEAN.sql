-- ============================================
-- KYNNECT SUPABASE DATABASE SETUP (CLEAN START)
-- Drops existing tables and recreates everything
-- ============================================

-- Drop all existing tables first (in correct order due to foreign keys)
DROP TABLE IF EXISTS event_promotions CASCADE;
