...
export function HomePage() {
  ...
  const backgroundStyle = selectedEthnicity
    ? {
        background: `linear-gradient(135deg, ${selectedEthnicity.primaryColor}25 0%, ${selectedEthnicity.secondaryColor}30 50%, ${selectedEthnicity.primaryColor}35 100%)`
      }
    : {};

  return (
    <div
      className="min-h-screen bg-gray-50 pb-20 transition-all duration-700"
