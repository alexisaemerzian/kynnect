...
interface AuthContextType {
  ...
  logout: () => Promise<void>;
  updateNotificationPreferences: (preferences: { notificationCity?: string; notificationCities?: string[]; emailNotifications?: boolean; smsNotifications?: boolean }) => Promise<void>;
